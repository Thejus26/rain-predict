...
#define STATUS_ERROR_NOT_FOUND          STATUS_ERR_NOT_FOUND
#define STATUS_ERROR_INTEGRITY          STATUS_ERR_INTEGRITY
#define STATUS_ERROR_GENERIC            STATUS_ERR_GENERIC
