...
- [x] [`Makefile`](file:///C:/Users/ENERGY%20SAVER/Documents/Learning/Job%20Projects/rain-predict/Makefile) created at repository root implementing all specified targets (`all`, `test`, `sim`, `firmware`, `coverage`, `asan`, `format`, `check-format`, `lint`, `clean`, `help`).
- [x] Cross-platform OS detection (Windows PowerShell / POSIX) handled cleanly.
- [x] `make help` produces formatted self-documenting output.
- [x] `make clean` deletes all generated build and coverage folders without leaving residual files.
- [x] All clickable links and file references resolve properly.
- [x] Spec document registered and linked under [`context/specs/spec-roadmap.md`](file:///C:/Users/ENERGY%20SAVER/Documents/Learning/Job%20Projects/rain-predict/context/specs/spec-roadmap.md#L97).
