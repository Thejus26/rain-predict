...
1. [x] `.devcontainer/Dockerfile` created with host GCC, ARM GCC, CMake, Cppcheck, Clang-Format, and Python libraries.
2. [x] `.devcontainer/devcontainer.json` created with VS Code settings and pre-configured extensions.
3. [x] `.devcontainer/post-create.sh` created with executable permissions and verification diagnostics.
4. [x] `.github/workflows/ci.yml` created to automate linting, host testing, simulation, and firmware cross-compilation on push.
5. [x] Task specification referenced in [`context/specs/spec-roadmap.md`](file:///C:/Users/ENERGY%20SAVER/Documents/Learning/Job%20Projects/rain-predict/context/specs/spec-roadmap.md) and [`context/current-feature.md`](file:///C:/Users/ENERGY%20SAVER/Documents/Learning/Job%20Projects/rain-predict/context/current-feature.md).
