...
static void test_mock_i2c_single_register_readback(void) {
...
static void test_mock_i2c_burst_readback(void) {
...
static void test_mock_i2c_driver_write_interception(void) {
...
static void test_mock_i2c_address_nack_fault(void) {
...
static void test_mock_i2c_timeout_fault(void) {
...
static void test_mock_i2c_data_corruption_fault(void) {
...
static void test_mock_i2c_delayed_fault_trigger(void) {
...
static void test_mock_i2c_reset_isolation(void) {
    (void)mock_i2c_set_register(BME280_I2C_ADDR, 0xD0U, 0x60U);
    mock_i2c_reset();
